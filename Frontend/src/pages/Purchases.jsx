      ...
      <Modal open={modal === 'form'} onClose={() => setModal(null)} title={editingId ? 'Edit Purchase' : 'Record Purchase'} size="lg">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-2 mb-2 flex items-center justify-between">
            <p className="text-sm font-medium text-ink-900">Items purchased</p>
        ...
        {viewTarget && (
          <div>
            <div className="mb-3 grid grid-cols-2 gap-2 text-sm">
              <div><span className="text-ink-500">Supplier:</span> <span className="font-medium">{suppliers.find((s) => s.id === viewTarget.supplierId)?.name}</span></div>
